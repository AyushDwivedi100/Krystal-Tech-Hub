...
<html lang="en">
  <head>
    ...
    <meta property="og:title" content="Our Services - Krystal Tech Hub" />
    <meta
      property="og:description"
      content="Explore Krystal Tech Hub's industrial solutions including automation, instrumentation, panels, and AMC."
    />
    ...
    <meta name="twitter:title" content="Our Services - Krystal Tech Hub" />
    <meta
  ...
  <body class="text-gray-800">
    ...
    <!-- HERO SECTION -->
    <section
      class="relative bg-gradient-to-br from-indigo-900 via-blue-900 to-blue-800 text-white py-20 pt-40 md:pt-48 overflow-hidden"
      data-aos="fade-in"
      data-aos-once="true"
    ...
    >
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <h1
          ...
          class="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-center"
          data-aos="zoom-in"
          data-aos-delay="200"
          data-aos-once="true"
        >
        ...
        <p
          class="text-lg sm:text-xl text-blue-100 max-w-3xl mx-auto text-center mb-8"
          data-aos="fade-up"
          data-aos-delay="400"
          data-aos-once="true"
          lang="en"
        ...
        <div class="flex flex-wrap justify-center gap-8 mt-10" data-aos="fade-up" data-aos-delay="500">
          <div class="flex items-center gap-3">
            ...
            <div class="text-left">
              <div class="font-semibold">Process Automation</div>
              <div class="text-xs text-blue-200">PLC, SCADA, HMI</div>
            </div>
          </div>
          <div class="flex items-center gap-3">
            ...
            <div class="text-left">
              <div class="font-semibold">Power Solutions</div>
              <div class="text-xs text-blue-200">Panels & Distribution</div>
            </div>
          </div>
          <div class="flex items-center gap-3">
            ...
            <div class="text-left">
              <div class="font-semibold">AMC Services</div>
              <div class="text-xs text-blue-200">24/7 Maintenance</div>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 id="services-list-title" class="text-3xl font-bold text-center mb-4 text-gray-800">
          What We Offer
        </h2>
