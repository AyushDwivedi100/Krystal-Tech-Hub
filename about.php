...
<html lang="en">
  ...
  <body class="text-gray-800">
    ...
    <section
      class="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-20 pt-40 md:pt-48 overflow-hidden"
      data-aos="fade-in"
      role="banner"
    ...
    >
      ...
      <div class="container mx-auto text-center px-4 relative z-10">
        <div class="flex justify-center gap-3 mb-6" data-aos="fade-down" data-aos-delay="100">
        ...
        <p
          class="text-lg md:text-xl text-blue-100 max-w-3xl mx-auto mb-8"
          data-aos="fade-up"
          data-aos-delay="400"
        >
        ...
        <div class="flex flex-wrap justify-center gap-6 mt-8" data-aos="fade-up" data-aos-delay="500">
          <div class="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-5 py-3 rounded-xl border border-white/10">
          ...
          <div class="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-5 py-3 rounded-xl border border-white/10">
            ...
            <div class="text-left">
              ...
              <div class="text-xs text-blue-200">Happy Clients</div>
            </div>
          </div>
          <div class="flex items-center gap-3 bg-white/5 backdrop-blur-sm px-5 py-3 rounded-xl border border-white/10">
            ...
            <div class="text-left">
              ...
              <div class="text-xs text-blue-200">Support Available</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Who We Are Section -->
    <section class="py-16 bg-white" aria-labelledby="who-we-are-heading">
      <div
      ...
      >
        ...
        <div
          ...
          data-aos-delay="200"
        >
          <h2 id="who-we-are-heading" class="text-3xl font-semibold mb-4">
            Who We Are
          </h2>
          ...
          <p class="text-gray-700 leading-relaxed mt-4 font-medium">
    ...
    >
      <div class="container mx-auto text-center mb-12 px-4">
        ...
        <p class="text-gray-600" data-aos="fade-left" data-aos-delay="200">
          A complete suite of industrial electrical & automation solutions
        </p>
      </div>
      <div
        class="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4"
        role="list"
