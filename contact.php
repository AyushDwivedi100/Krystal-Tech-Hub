...
<html lang="en">
  ...
  <body class="text-gray-800">
    ...
    <!-- Hero Section -->
    <section
      class="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white py-20 pt-40 md:pt-48 overflow-hidden"
      data-aos="fade-in"
    ...
    >
      ...
      <div class="container mx-auto px-4 relative z-10 text-center">
        <div class="flex flex-wrap justify-center gap-3 mb-6" data-aos="fade-down" data-aos-delay="100">
          <span class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-sm px-4 py-2 rounded-full border border-white/20">
        ...
        <p class="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8" data-aos="fade-up" data-aos-delay="350">
          We're here to answer your queries and help you start your next industrial
          project. Reach out today!
        </p>

        <div class="flex flex-wrap justify-center gap-6 mt-8" data-aos="fade-up" data-aos-delay="450">
          <a href="tel:+918808408802" class="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-4 rounded-xl border border-white/20 hover:bg-white/20 transition duration-300 group">
            <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition">
              <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
              </svg>
            </div>
            <div class="text-left">
              <div class="text-xs text-blue-200">Call Us Now</div>
              <div class="font-semibold">+91 88084 08802</div>
            </div>
          </a>
          <a href="mailto:info@krystaltechhub.in" class="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-6 py-4 rounded-xl border border-white/20 hover:bg-white/20 transition duration-300 group">
            <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition">
              <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="text-left">
              ...
              <div class="font-semibold">info@krystaltechhub.in</div>
            </div>
          </a>
        </div>
      </div>
    ...
    >
      <div
        class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12"
      >
        <!-- Contact Info -->
        <div data-aos="fade-right" data-aos-delay="150">
          <h2 id="contact-info-heading" class="text-2xl font-semibold mb-4">
            Get In Touch
          </h2>
          <p class="text-gray-700 mb-6">
            Fill out the form or reach out using the information below.
          </p>
          <ul class="text-gray-700 space-y-4 mb-8">
            <li>
              <strong>Email:</strong>
              <a
