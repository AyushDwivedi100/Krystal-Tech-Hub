...
<html lang="en">
  ...
  >
    ...
    <main id="main-content" role="main" aria-label="Main content">
      ...
      <section
        id="home"
        class="hero flex items-center justify-center text-center text-white min-h-screen pt-32 md:pt-36"
        data-aos="fade-in"
      ...
      >
        ...
        >
          <h1 class="text-4xl md:text-6xl font-bold mb-4">
            Powering Industries with Precision, <br />Performance & Progress
          </h1>
          <p
          ...
          <a
            href="#contact"
            class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full transition duration-300 inline-block"
            data-aos="fade-up"
            data-aos-delay="700"
          >
            Get in Touch
      ...
      <section
        id="about"
        class="py-16 bg-white overflow-x-hidden"
        ...
        <div class="container mx-auto px-6">
          ...
          <div class="flex flex-col md:flex-row md:items-center md:gap-10">
            ...
            <div class="md:w-1/2 space-y-6" data-aos="fade-left">
              ...
              <!-- Highlight 1 -->
              <div
                class="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-600 flex items-start gap-4 shadow-sm"
              >
                <!-- Icon: Factory -->
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6 text-blue-600 mt-1 shrink-0"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
              ...
              <!-- Highlight 2 -->
              <div
                class="bg-green-50 p-5 rounded-lg border-l-4 border-green-600 flex items-start gap-4 shadow-sm"
              >
                <!-- Icon: Clock/Experience -->
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6 text-green-600 mt-1 shrink-0"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path
      ...
      >
        <div class="container mx-auto px-6">
          <h2
            id="services-heading"
            class="text-3xl font-bold text-center mb-4 section-title"
            data-aos="fade-down"
          >
            Our Key Offerings
          </h2>
